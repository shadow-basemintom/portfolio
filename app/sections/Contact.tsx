...
const Contact = () => {
  const formName = "anton"; // Form name to keep it consistent with the API
  ...
  const contactInfo = [
    {
      icon: <FiMail size={22} />,
      label: "Email",
      value: "keith.musiyiwa@mail.com",
      link: "keith.musiyiwa@mail.com",
    },
    {
          ...
          >
            ...
            >
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/shadow-basemintom"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/keith-musiyiwa-1241bb26a/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="h-12 w-12 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm flex items-center justify-center text-gray-700 dark:text-gray-300 hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:-translate-y-1"
                  aria-label="LinkedIn"
