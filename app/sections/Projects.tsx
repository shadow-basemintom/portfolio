...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Comprehensive educational platform focused on data communication and computer networking. Features detailed tutorials, examples, and education content in Bengali language.",
      image: "/images/placeholder-project.svg",
